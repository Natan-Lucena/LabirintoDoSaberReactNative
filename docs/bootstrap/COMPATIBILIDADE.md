...
| 13  | `pnpm add @tanstack/react-query-persist-client@5.103.2 @tanstack/query-sync-storage-persister@5.103.2` (T-304, G-26, no repositório) | 0      | Instaladas na linha 5.103.2 do `@tanstack/react-query`                                                                                                                                                                        |
| 14  | `pnpm peers check` (T-304, após o persister)                                                                                         | 0      | Sem conflitos                                                                                                                                                                                                                 |
| 15  | `npx expo-doctor` (T-304, após o persister)                                                                                          | 0      | 21/21                                                                                                                                                                                                                         |
